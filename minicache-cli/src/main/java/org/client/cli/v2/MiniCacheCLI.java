...
public class MiniCacheCLI extends BaseMiniCacheCLI {
    ...
    public static void execute(String host, Integer port, String commandText) {
        ...
        try (Socket socket = new Socket(host, port);
            ...
            switch (action) {
                ...
                case "Z.TOP" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: Z.TOP <key> <top>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x29, parts[1], null, "0", "0",
                            null, null, parts[2], null,
                ...
                case "GEO.ADD" -> {
                    if (parts.length < 5) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.ADD <key> <member> <lat> <lon>");
                        return;
                    }
                ...
                case "GEO.SEARCH" -> {
                    if (parts.length < 5) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.SEARCH <key> <lat> <lon> <radius_meters> <limit>");
                        return;
                    }
                    String limit = (parts.length > 5) ? parts[5] : "0";
                ...
                case "GEO.DIST" -> {
                    if (parts.length < 4) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.DIST <key> <member1> <member2>");
                        return;
                    }
                ...
                case "GEO.DEL" -> {
                    if (parts.length < 2) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.DEL <key>");
                        return;
                    }
                ...
                case "GEO.RM" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.RM <key> <member>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x26, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                ...
                case "GEO.GET" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.GET <key> <member>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x27, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            parts[2], null, null, null, null, null,
                            null);
                ...
                case "GEO.NB" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.NB <key> <member>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x28, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            parts[2], null, null, null, null, null,
                            null);
                ...
                case "GEO.EXISTS" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.EXISTS <key> <member>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x30, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            parts[2], null, null, null, null, null,
                            null);
                ...
                case "GEO.ENCODE" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: GEO.ENCODE <key> <member>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x31, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            parts[2], null, null, null, null, null,
                            null);
                ...
                case "H.SET" -> {
                    if (parts.length < 4) {
                        log.info("(error) ERR Invalid command. Syntax: H.SET <key> <field> <value>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x32, parts[1], parts[3], "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null, null, null,
                            parts[2]);
                ...
                case "H.GET" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: H.GET <key> <field>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x33, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null, null, null,
                            parts[2]);
                ...
                case "H.ALL" -> {
                    if (parts.length < 2) {
                        log.info("(error) ERR Invalid command. Syntax: H.ALL <key>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x34, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null, null, null,
                            null);
                ...
                case "H.RM" -> {
                    if (parts.length < 3) {
                        log.info("(error) ERR Invalid command. Syntax: H.RM <key> <field>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x35, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null, null, null,
                            parts[2]);
                ...
                case "H.DEL" -> {
                    if (parts.length < 2) {
                        log.info("(error) ERR Invalid command. Syntax: H.DEL <key>");
                        return;
                    }
                    sendBinaryRequest(out, (byte) 0x36, parts[1], null, "0", "0",
                            null, null, null, null,
                            null, null, null, null, null,
                            null, null, null, null, null, null,
                            null);
    ...
    private static void sendBinaryRequest(DataOutputStream out, byte code, String key, String value,
        ...
        try {
            ...
            out.writeDouble(geoLat != null ? Double.parseDouble(geoLat) : 0d);
            out.writeDouble(geoLon != null ? Double.parseDouble(geoLon) : 0d);
            out.writeUTF(geoMem2 != null ? geoMem2 : "");
            out.writeDouble(geoRadius != null ? Double.parseDouble(geoRadius) : 0d);
